...
contract Mytoken is ERC20, Ownable {
    ...
    string public name_ = "Jack Token";//名称
    string public symbol_ = "Jack";//简称
    uint256 public totalSupply_ = 300000;//供应量 不用后面18位
    address public rewardAddr_ = 0x55d398326f99059fF775485246999027B3197955;//分红币合约地址
    address public marketingWalletAddr_ = 0x583682d02AFA1610dA14B43a49ba314D87B35bCA;//营销钱包地址
    uint256[4] public  buyFeeSetting_ = [1,1,1,1];//买入手续费：持币分红、回流、营销钱包、销毁
    uint256[4] public  sellFeeSetting_ = [1,1,1,1];//卖出手续费：持币分红、回流、营销钱包、销毁
    uint256 public tokenBalanceForReward_ = 3000000000000000000;//持币门槛，后面+18个0
